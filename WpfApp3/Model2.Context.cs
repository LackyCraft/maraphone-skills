...
namespace WpfApp3
{
    ...
    public partial class ws2016Entities3 : DbContext
    {
        private static ws2016Entities3 _context;

        public ws2016Entities3()
            : base("name=ws2016Entities3")
        {
        }


        public static ws2016Entities3 GetContext()
        {
            if (_context == null)
                _context = new ws2016Entities3();
            return _context;
        }
